...
let
  cfg = config.bastionNginx;
in
{
  imports = [
    ../../config/modules/bastion-nginx.nix
  ];
  ...
  config = {
    ...
    services.nginx = {
      ...
      virtualHosts."webmail.${cfg.domain}" = {
        forceSSL = true;
        enableACME = true;
      };

      virtualHosts."nextcloud.${cfg.domain}" = {
        forceSSL = true;
        enableACME = true;
      ...
      virtualHosts."dissona.${cfg.domain}" = {
        forceSSL = true;
        enableACME = true;
